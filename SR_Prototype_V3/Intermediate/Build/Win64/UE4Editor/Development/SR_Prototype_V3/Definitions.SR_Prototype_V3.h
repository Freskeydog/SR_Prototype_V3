...
#define ORIGINAL_FILE_NAME "UE4Editor-SR_Prototype_V3.dll"
#define UE_IS_ENGINE_MODULE 0
#define UE_BUILD_DEVELOPMENT_WITH_DEBUGGAME 0
#define UE_PROJECT_NAME SR_Prototype_V3
#define DEPRECATED_FORGAME DEPRECATED
#define SR_PROTOTYPE_V3_API DLLEXPORT
